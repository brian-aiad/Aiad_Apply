...
TERM_CATALOG: dict[str, KeywordKind] = {
    ...
    "kiosk": KeywordKind.system,
    "connected devices": KeywordKind.environment,
    "device management": KeywordKind.action,
    ...
    "network connectivity": KeywordKind.system,
    ...
    "remote troubleshooting tools": KeywordKind.system,
